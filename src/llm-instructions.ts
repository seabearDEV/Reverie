...
- codex_context may also prepend a "[warning: ... still exceeds budget after shedding ...]" notice. This means the never-shed namespaces alone are over budget — surface this to the user so they can either raise bootstrap_max_response_bytes via codex_config_set or audit project.*/conventions.* for over-long entries.
